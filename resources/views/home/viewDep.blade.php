...
@section('content')
    <div class="container  mt-5">
        <div class="row">
            <div class="col">
                <a href="{{ route('home.ViewDep', $departments->id) }}"
                    class="text-capitalise h1 text-decoration-none">{{ $departments->dep_title }}</a>
            </div>
        </div>
    </div>
                                                ...
                                                <span>
                                                    <h4 class="h5 text-truncate mt-2">{{ $pro->title }}</h4>
                                                        @if ($departments->id == $pro->department_id)
                                                            <span class="badge bg-success float-end">{{ $departments->dep_title }}
                                                            </span>
                                                        @endif
                                                </span>
