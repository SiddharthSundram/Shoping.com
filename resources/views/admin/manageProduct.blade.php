    ...
    <div class="container mt-3 mb-3">
        <div class="row">
            ...
            <div class="col-md-4 text-md-end">
                <a href="{{ route('admin.product.insert') }}" class="btn btn-success mt-1">Insert Product</a>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            @foreach ($products as $item)
                                <tr >
                                    ...
                                    <td class="text-truncate text-center" style="max-width: 150px">{{ $item->description }}</td>
                                    <td class="text-success text-center">Rs.{{ $item->discount_price }}/- <del
                                            class="text-danger small">Rs.{{ $item->price }}/-</del></td>
                                    <td class="text-center"><img src="{{ asset('storage/' . $item->image) }}" class="img-fluid rounded "
                                            ...
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content bg-dark text-white">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Edit Product - "{{ $item->title }}"</h5>
                                                            ...
                                                            <div class="card-body">
                                                                <form action="{{route('admin.product.update',$item->id)}}" method="POST"
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" name="discount_price" class="form-control" value="{{$item->discount_price}}">
                                                                    ...
                                                                    <div class="mb-3 d-flex">
                                                                        <input type="radio" name="isAds" class="form-check" value="0" >No 
